...
export class InitialMigration1683304239490 implements MigrationInterface {
    name = 'InitialMigration1683304239490'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedules" ("id" SERIAL NOT NULL, "date" date NOT NULL, "hour" TIME NOT NULL, "realEstatesId" integer, "userId" integer, CONSTRAINT "PK_7e33fc2ea755a5765e3564e66dd" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "schedules" ADD CONSTRAINT "FK_b2e54237377c6f210dee4d15fb9" FOREIGN KEY ("realEstatesId") REFERENCES "real_estate"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
